    ...
    const fetchMetadataAndCompletion = async () => {
      try {
        ...
        const [quiz1Response, quiz2Response] = await Promise.all([
          axios.get("http://localhost/backend/api/fetch-questions.php"),
          axios.get("http://localhost/backend/api/fetch-questions2.php"),
        ]);
  ...
  const quiz2Status = useMemo(() => {
   ...
   const handleCertificateClick = () => {
    if (quiz1Status === 'Completed' && quiz2Status === 'Completed') {
      ...
      navigate(`/certificate/${currentCourseId}`);
    } else {
        ...
        <div className="card-body d-flex flex-column flex-md-row justify-content-between align-items-start">
          <div className="d-flex align-items-center w-100 mb-3 mb-md-0">
            ...
            <div className="card-body d-flex justify-content-between align-items-center">
              <div style={{ flex: 1 }}>
                <h5 className="card-title mb-2">Python Programming in Hindi</h5>
                ...
                <div className="mt-2">
                  <Link to={`/course-content/${currentCourseId}`}>
        ...
        {activeSection === "assessments" && (
          <div style={{ marginBottom: "35px" }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '25px' }}>
              ...
              <Link to={`/progress-report/${currentCourseId}`}>
            ...
            <div className="mt-3">
              {[1, 2].map((num) => {
                ...
                const link = num === 1 ? `/assessment/${currentCourseId}` : `/assessment2/${currentCourseId}`;
